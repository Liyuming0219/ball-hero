...
const GameMaps = [
    {
        ...
        icon: '🌌',
        // 视觉主题配置
        bgGrad: ['#020208', '#06061a', '#040412'],
        glowA: 'rgba(60,20,140,0.35)',
        glowB: 'rgba(20,30,100,0.28)',
        gridColor: 'rgba(40,30,90,0.45)',
        dotColor: '#2a2a66',
        starColor: '#9988dd',
        fogColor: 'rgba(20,10,50,0.08)',
        decorType: 'crystal',
        decorColor: '#7744cc',
        // 环境特色
    ...
    },
    {
        ...
        icon: '🔥',
        bgGrad: ['#0a0202', '#180808', '#100505'],
        glowA: 'rgba(140,20,10,0.38)',
        glowB: 'rgba(100,40,10,0.28)',
        gridColor: 'rgba(80,25,15,0.40)',
        dotColor: '#442211',
        starColor: '#cc7744',
        fogColor: 'rgba(80,10,5,0.12)',
        decorType: 'pillar',
        decorColor: '#aa5533',
    ...
    },
    {
        ...
        icon: '❄️',
        bgGrad: ['#020610', '#06101e', '#040a16'],
        glowA: 'rgba(20,50,140,0.35)',
        glowB: 'rgba(10,80,120,0.30)',
        gridColor: 'rgba(30,60,100,0.40)',
        dotColor: '#1a3a55',
        starColor: '#77bbee',
        fogColor: 'rgba(10,25,60,0.12)',
        decorType: 'iceSpike',
        decorColor: '#3399bb',
    ...
    },
    {
        ...
        icon: '🌲',
        bgGrad: ['#030804', '#080e06', '#050a04'],
        glowA: 'rgba(10,70,25,0.32)',
        glowB: 'rgba(50,80,10,0.26)',
        gridColor: 'rgba(25,55,18,0.38)',
        dotColor: '#1a3311',
        starColor: '#66cc66',
        fogColor: 'rgba(10,40,8,0.15)',
        decorType: 'tree',
        decorColor: '#448833',
    ...
    },
    {
        ...
        icon: '🌋',
        bgGrad: ['#080200', '#120600', '#0e0400'],
        glowA: 'rgba(180,40,0,0.38)',
        glowB: 'rgba(150,70,0,0.28)',
        gridColor: 'rgba(120,35,5,0.35)',
        dotColor: '#552200',
        starColor: '#dd8822',
        fogColor: 'rgba(80,20,0,0.14)',
        decorType: 'lavaRock',
        decorColor: '#cc4400',
    ...
    },
    {
        ...
        icon: '✨',
        bgGrad: ['#040410', '#0a0a20', '#060616'],
        glowA: 'rgba(80,60,10,0.35)',
        glowB: 'rgba(40,25,90,0.28)',
        gridColor: 'rgba(55,45,25,0.38)',
        dotColor: '#332a11',
        starColor: '#ccaa66',
        fogColor: 'rgba(30,25,5,0.10)',
        decorType: 'ruins',
        decorColor: '#bb8833',
