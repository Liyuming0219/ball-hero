...
const GameMaps = [
    {
        ...
        icon: '🌌',
        // 视觉主题配置
        bgGrad: ['#1a1048', '#2a1e68', '#1e1450'],
        glowA: 'rgba(90,40,180,0.40)',
        glowB: 'rgba(40,50,160,0.35)',
        gridColor: 'rgba(90,60,180,0.60)',
        dotColor: '#5555aa',
        starColor: '#bb99ff',
        fogColor: 'rgba(60,30,140,0.20)',
        decorType: 'crystal',
        decorColor: '#9966ee',
        // 环境特色
        ambientParticles: { color: '#aa77ff', count: 35, speed: 0.3, glow: true },
    ...
    },
    {
        ...
        icon: '🔥',
        bgGrad: ['#2a1010', '#3d1818', '#321212'],
        glowA: 'rgba(180,40,20,0.42)',
        glowB: 'rgba(140,60,20,0.35)',
        gridColor: 'rgba(160,55,30,0.60)',
        dotColor: '#884433',
        starColor: '#ff9966',
        fogColor: 'rgba(150,30,15,0.22)',
        decorType: 'pillar',
        decorColor: '#cc6644',
        ambientParticles: { color: '#ff6644', count: 40, speed: 0.6, glow: true },
    ...
    },
    {
        ...
        icon: '❄️',
        bgGrad: ['#142840', '#1e3c58', '#183248'],
        glowA: 'rgba(40,80,180,0.40)',
        glowB: 'rgba(20,110,160,0.35)',
        gridColor: 'rgba(60,110,190,0.60)',
        dotColor: '#4477aa',
        starColor: '#99ddff',
        fogColor: 'rgba(30,60,140,0.22)',
        decorType: 'iceSpike',
        decorColor: '#55bbdd',
        ambientParticles: { color: '#aaddff', count: 45, speed: 0.2, glow: true },
    ...
    },
    {
        ...
        icon: '🌲',
        bgGrad: ['#183820', '#224828', '#1c3e22'],
        glowA: 'rgba(20,110,45,0.38)',
        glowB: 'rgba(70,110,20,0.32)',
        gridColor: 'rgba(55,120,40,0.60)',
        dotColor: '#448828',
        starColor: '#88ee88',
        fogColor: 'rgba(30,90,25,0.22)',
        decorType: 'tree',
        decorColor: '#66aa55',
        ambientParticles: { color: '#66ffaa', count: 50, speed: 0.15, glow: true },
    ...
    },
    {
        ...
        icon: '🌋',
        bgGrad: ['#2c1400', '#401e00', '#361800'],
        glowA: 'rgba(220,60,0,0.42)',
        glowB: 'rgba(180,90,0,0.35)',
        gridColor: 'rgba(200,70,15,0.60)',
        dotColor: '#aa5500',
        starColor: '#ffaa44',
        fogColor: 'rgba(160,50,0,0.22)',
        decorType: 'lavaRock',
        decorColor: '#ee6622',
        ambientParticles: { color: '#ffaa33', count: 35, speed: 0.8, glow: true },
    ...
    },
    {
        ...
        icon: '✨',
        bgGrad: ['#1e1840', '#2e2860', '#24204c'],
        glowA: 'rgba(120,90,20,0.40)',
        glowB: 'rgba(70,45,130,0.35)',
        gridColor: 'rgba(110,90,50,0.60)',
        dotColor: '#887744',
        starColor: '#ffcc88',
        fogColor: 'rgba(75,60,25,0.20)',
        decorType: 'ruins',
        decorColor: '#ddaa55',
        ambientParticles: { color: '#ffee88', count: 30, speed: 0.1, glow: true },
